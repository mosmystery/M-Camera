...
if (_input.shake)
{
	global.camera.shake_to(0.5);		// set the intensity of the shake and optionally resets the shake transform values. Try a value between 0 and 1. Or, hell, try 1000, why not. See .shake_to(), .shake_by(), .set_shake_limits() and .set_shake_interpolation().
}
